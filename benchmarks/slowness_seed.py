...
SLOWNESS_SEED: dict[str, dict[str, Any]] = {
    ...
    "1472_design_browser_history": mixed("stateful_object", "field_clone", "list_clone", parity="equivalent"),
    "0208_implement_trie_prefix_tree": mixed("trie_parity", "field_clone", "dict_clone", "stateful_object", parity="equivalent"),
...
FAILED_SEED: dict[str, dict[str, Any]] = {
    ...
    "0083_remove_duplicates_from_sorted_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0876_middle_of_the_linked_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0019_remove_nth_node_from_end_of_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "1721_swapping_nodes_in_a_linked_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0002_add_two_numbers": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0141_linked_list_cycle": {"benchmark_status": "failed_build", "slowness_tags": ["optional_type", "list_node_clone"]},
    "0024_swap_nodes_in_pairs": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0148_sort_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0086_partition_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
    "0061_rotate_list": {"benchmark_status": "failed_build", "slowness_tags": ["moved_value", "list_node_clone"]},
