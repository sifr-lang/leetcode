...
function findCheapestPrice(self, n, flights, src, dst, k) {
...
if (require.main === module) {
  ...
  assert.strictEqual(findCheapestPrice(null, 4, [[0, 1, 100], [1, 2, 100], [2, 0, 100], [1, 3, 600], [2, 3, 200]], 0, 3, 1), 700);
  assert.strictEqual(findCheapestPrice(null, 3, [[0, 1, 100], [1, 2, 100], [0, 2, 500]], 0, 2, 1), 200);
  assert.strictEqual(findCheapestPrice(null, 3, [[0, 1, 100], [1, 2, 100], [0, 2, 500]], 0, 2, 0), 500);
}
