...
if (require.main === module) {
  ...
  assert.strictEqual(furthestBuilding([4, 2, 7, 6, 9, 14, 12], 5, 1), 4);
  assert.strictEqual(furthestBuilding([4, 12, 2, 7, 3, 18, 20, 3, 19], 10, 2), 7);
  assert.strictEqual(furthestBuilding([14, 3, 19, 3], 17, 0), 3);
}
