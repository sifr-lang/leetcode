...
function isEvenOddTree(root) {
  ...
  while (q.length) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      else if (!even && (node.val % 2 === 1 || node.val >= prev)) return false;
...
if (require.main === module) {
  ...
  assert.strictEqual(isEvenOddTree(new TreeNode(1, new TreeNode(10, new TreeNode(3, new TreeNode(12, null, null), new TreeNode(8, null, null)), null), new TreeNode(4, new TreeNode(7, new TreeNode(6, null, null), null), new TreeNode(9, null, new TreeNode(2, null, null))))), true);
  assert.strictEqual(isEvenOddTree(new TreeNode(5, new TreeNode(4, new TreeNode(3, null, null), new TreeNode(3, null, null)), new TreeNode(2, new TreeNode(7, null, null), null))), false);
  assert.strictEqual(isEvenOddTree(new TreeNode(5, new TreeNode(9, new TreeNode(3, null, null), new TreeNode(5, null, null)), new TreeNode(1, new TreeNode(7, null, null), null))), false);
}
