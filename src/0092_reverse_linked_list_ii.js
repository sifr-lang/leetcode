...
function reverseBetween(self, head, left, right) {
  ...
  for (let i = 0; i < left - 1; i++) { leftPrev = cur; cur = cur.next; }
  let prev = null;
...
if (require.main === module) {
  ...
  assert.strictEqual(listNodeToString(reverseBetween(null, new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, new ListNode(5))))), 2, 4)), '1->4->3->2->5');
  assert.strictEqual(listNodeToString(reverseBetween(null, new ListNode(5), 1, 1)), '5');
}
