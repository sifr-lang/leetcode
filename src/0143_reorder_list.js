...
if (require.main === module) {
  ...
  let arg0 = new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, null))));
  reorderList(arg0);
  assert.strictEqual(listNodeToString(arg0), listNodeToString(new ListNode(1, new ListNode(4, new ListNode(2, new ListNode(3, null))))));
  arg0 = new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, new ListNode(5, null)))));
  reorderList(arg0);
  assert.strictEqual(listNodeToString(arg0), listNodeToString(new ListNode(1, new ListNode(5, new ListNode(2, new ListNode(4, new ListNode(3, null)))))));
}
