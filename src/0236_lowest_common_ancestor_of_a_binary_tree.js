...
if (require.main === module) {
  ...
  const root = new TreeNode(3, new TreeNode(5, new TreeNode(6, null, null), new TreeNode(2, new TreeNode(7, null, null), new TreeNode(4, null, null))), new TreeNode(1, new TreeNode(0, null, null), new TreeNode(8, null, null)));
  assert.strictEqual(treeToString(lowestCommonAncestor(root, root.left, root.right)), treeToString(root));
  assert.strictEqual(treeToString(lowestCommonAncestor(root, root.left, root.left.right.right)), treeToString(root.left));
  const root2 = new TreeNode(1, new TreeNode(2, null, null), null);
  assert.strictEqual(treeToString(lowestCommonAncestor(root2, root2, root2.left)), treeToString(root2));
}
