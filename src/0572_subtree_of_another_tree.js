...
if (require.main === module) {
    ...
    assert.deepStrictEqual(isSubtree(new TreeNode(3, new TreeNode(4, new TreeNode(1, null, null), new TreeNode(2, null, null)), new TreeNode(5, null, null)), new TreeNode(4, new TreeNode(1, null, null), new TreeNode(2, null, null))), true);
    assert.deepStrictEqual(isSubtree(new TreeNode(3, new TreeNode(4, new TreeNode(1, null, null), new TreeNode(2, new TreeNode(0, null, null), null)), new TreeNode(5, null, null)), new TreeNode(4, new TreeNode(1, null, null), new TreeNode(2, null, null))), false);
}
