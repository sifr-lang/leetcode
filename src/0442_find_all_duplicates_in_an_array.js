...
if (require.main === module) {
  ...
  assert.deepStrictEqual(findDuplicates([4, 3, 2, 7, 8, 2, 3, 1]), [2, 3]);
  assert.deepStrictEqual(findDuplicates([1, 1, 2]), [1]);
  assert.deepStrictEqual(findDuplicates([1]), []);
}
