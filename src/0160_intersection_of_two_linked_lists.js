...
if (require.main === module) {
  ...
  assert.strictEqual(listNodeToString(getIntersectionNode(null, headA, headB)), '8->4->5');
  const headC = new ListNode(2, new ListNode(6, new ListNode(4)));
  const headD = new ListNode(1, new ListNode(5));
  assert.strictEqual(listNodeToString(getIntersectionNode(null, headC, headD)), 'None');
}
