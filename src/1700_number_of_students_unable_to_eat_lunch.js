...
function countStudents(students, sandwiches) {
  let numOfStudentsBackInLine = 0;
  while (numOfStudentsBackInLine !== students.length) {
    const currStudent = students.shift();
    if (currStudent === sandwiches[0]) { sandwiches.shift(); numOfStudentsBackInLine = 0; }
    else { students.push(currStudent); numOfStudentsBackInLine += 1; }
  }
