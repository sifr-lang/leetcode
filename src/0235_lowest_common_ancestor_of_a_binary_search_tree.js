...
if (require.main === module) {
  ...
  assert.strictEqual(treeToString(lowestCommonAncestor(null, root, root.left, root.right)), treeToString(root));
  assert.strictEqual(treeToString(lowestCommonAncestor(null, root, root.left, root.left.right)), treeToString(root.left));
  assert.strictEqual(treeToString(lowestCommonAncestor(null, new TreeNode(2, new TreeNode(1), null), new TreeNode(2), new TreeNode(1))), treeToString(new TreeNode(2, new TreeNode(1), null)));
}
